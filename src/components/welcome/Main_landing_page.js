    ...
    <section className="container min-h-screen mx-auto py-16">
        <div className="flex flex-col md:flex-row items-center px-10">
            <div className="w-full md:w-1/2">
                <h1 className="text-4xl md:text-6xl font-bold text-grass9 mb-5">Build Habits, Share Progress, Achieve Together.</h1>
            ...
            <div className="w-full md:w-1/2">
                <Image src="/images/img_block32.webp" alt="landing page pic" width={500} height={500}></Image>
            </div>
